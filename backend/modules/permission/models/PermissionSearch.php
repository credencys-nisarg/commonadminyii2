...
/**
 * PermissionSearch represents the model behind the search form about `backend\modules\permission\models\Permission`.
 */
class PermissionSearch extends Permission
{
    ...
    {
        return [
            [['permission_id', 'roleid', 'userid'], 'integer'],
            [['action_name', 'class_name'], 'safe'],
        ];
    }
